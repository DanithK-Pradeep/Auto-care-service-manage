...
<body class="antialiased">
    ...
    <div class="h-screen bg-cover bg-center bg-fixed overflow-hidden" style="background-image: url('<?= base_url('assets/images/bg.png') ?>');">

        <div class="h-screen bg-white/30 backdrop-blur-md flex flex-col">
            ...
            <div class="flex flex-1 overflow-hidden">
                ...
                <main class="flex-1 overflow-y-auto p-6 custom-scrollbar" id="main-content">
                    <div class="bg-white/60 p-6 rounded-3xl shadow-xl backdrop-blur-sm border border-white/20 min-h-full">
